...
```{r pressure, echo=FALSE, fig.cap="PCA plot before correction", out.width = '100%'}
knitr::include_graphics("https://github.com/qzhan321/dmatch/tree/master/man/pngs/pc_plot.png")
```
